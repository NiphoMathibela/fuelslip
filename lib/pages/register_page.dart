    ...
    return Scaffold(
      ...
      children: [
        TextField(
          ...
          decoration: const InputDecoration(labelText: 'Name / Company Name', border: OutlineInputBorder(), hintText: 'Enter your name or company name', prefixIcon: Icon(Icons.person_outline), enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(12.0)), borderSide: BorderSide(color: Colors.grey))),
        ),
